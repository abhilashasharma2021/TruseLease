...
public class ChatWithAdminAdapter extends RecyclerView.Adapter<ChatWithAdminAdapter.ViewHolder> {

    List<ShowAdminChatModel.Result> chatList;
    Context context;

    public ChatWithAdminAdapter(List<ShowAdminChatModel.Result> chatList, Context context) {
    ...
    @NonNull
    @Override
    public ChatWithAdminAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.chat_layout, parent, false);
        return new ChatWithAdminAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ChatWithAdminAdapter.ViewHolder holder, int position) {

        ShowAdminChatModel.Result data = chatList.get(position);
